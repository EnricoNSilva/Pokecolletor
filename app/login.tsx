...
export default function LoginScreen() {
  ...
  async function handleLogin() {
    if (!isFirebaseConfigured) {
      showFeedback('Firebase nao configurado. Preencha as variaveis no .env.', 'error');
      return;
    }
    ...
    try {
      ...
      if (error?.code === 'auth/too-many-requests') {
        showFeedback('Muitas tentativas. Aguarde alguns instantes e tente novamente.', 'error');
        return;
      }
